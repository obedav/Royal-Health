...
const Register: React.FC = () => {
  ...
  const getFieldState = (fieldName: string, value: string, error: any) => {
  ...
  // Helper function to get field icon color
  const getFieldIconColor = (fieldName: string, value: string, error: any) => {
    const state = getFieldState(fieldName, value, error);
    switch (state) {
  ...
  const getFieldBorderColor = (fieldName: string, value: string, error: any, isHovered = false) => {
    const state = getFieldState(fieldName, value, error);
    switch (state) {
      case 'success': return isHovered ? 'green.400' : 'green.300';
      case 'error': return isHovered ? 'red.400' : 'red.300';
      default: return isHovered ? 'brand.400' : 'gray.300';
    }
  };
  ...
  return (
    <div
      style={{
        ...
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, #FCE7F3 0%, #F3E5F5 50%, #C2185B08 100%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      <Container maxW={{ base: "md", md: "lg", lg: "xl" }} px={{ base: 4, md: 6 }}>
        <Card
          ...
          <CardBody p={{ base: 6, md: 8, lg: 10 }}>
            <VStack spacing={{ base: 6, md: 8 }} align="stretch">
              ...
              <VStack spacing={4} textAlign="center" className="header-container">
                ...
                >
                  <Icon as={FaUserFriends} color="white" fontSize={{ base: "xl", md: "2xl" }} />
                </Box>
                ...
                <VStack spacing={3}>
                  ...
                  <Text color="gray.600" fontSize={{ base: "md", md: "lg" }} fontWeight="500">
                    Create your account to access professional healthcare
                    services
                  </Text>
                </VStack>
              </VStack>
              ...
              {error && (
                ...
                >
                  <AlertIcon />
                  <Text fontWeight="600" fontSize="sm">{error}</Text>
                </Alert>
              )}
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <VStack spacing={6}>
                  ...
                  <FormControl isInvalid={!!errors.role}>
                    <FormLabel fontWeight="700" color="gray.700" fontSize="md">
                      I am a:
                    </FormLabel>
                    <RadioGroup
                      value={selectedRole}
                      onChange={(value) =>
                        setValue("role", value as "client" | "nurse")
                      }
                    >
                      <HStack spacing={{ base: 3, md: 4 }} flexDirection={{ base: "column", sm: "row" }}>
                        <Box
                          flex={1}
                          p={{ base: 4, md: 5 }}
                          borderRadius="xl"
                          border="3px solid"
                          borderColor={
                            selectedRole === "client" ? "brand.500" : "gray.200"
                          }
                          bgGradient={
                            selectedRole === "client"
                              ? "linear(135deg, brand.50, brand.25)"
                              : "linear(135deg, gray.50, white)"
                          }
                          cursor="pointer"
                        ...
                        <Box
                          ...
                          border="3px solid"
                          borderColor={
                            selectedRole === "nurse" ? "purple.500" : "gray.200"
                          }
                          bgGradient={
                            selectedRole === "nurse"
                              ? "linear(135deg, purple.50, purple.25)"
                              : "linear(135deg, gray.50, white)"
                          }
                          cursor="pointer"
                  ...
                  <HStack spacing={4} w="full" flexDirection={{ base: "column", md: "row" }}>
                    <FormControl isInvalid={touchedFields.firstName && !!errors.firstName}>
                      <FormLabel fontWeight="700" color="gray.700" fontSize="md">
                        First Name {getFieldState('firstName', firstName, errors.firstName) === 'success' && (
                      ...
                      <InputGroup>
                        <InputLeftElement>
                          <Icon
                            as={FaUser}
                            color={getFieldIconColor('firstName', firstName, errors.firstName)}
                          />
                        </InputLeftElement>
                        <Input
                          {...register("firstName")}
                          ...
                          borderRadius="xl"
                          borderWidth="2px"
                          borderColor={getFieldBorderColor('firstName', firstName, errors.firstName)}
                          _hover={{
                            borderColor: getFieldBorderColor('firstName', firstName, errors.firstName, true),
                          }}
                          _focus={{
                            borderColor: getFieldState('firstName', firstName, errors.firstName) === 'error' 
                              ? 'red.500' 
                              : getFieldState('firstName', firstName, errors.firstName) === 'success'
                                ? 'green.500' 
                                : 'brand.500',
                            boxShadow: getFieldState('firstName', firstName, errors.firstName) === 'error'
                    ...
                    <FormControl isInvalid={touchedFields.lastName && !!errors.lastName}>
                      <FormLabel fontWeight="700" color="gray.700" fontSize="md">
                        Last Name {getFieldState('lastName', lastName, errors.lastName) === 'success' && (
                          <Text as="span" color="green.500" fontSize="sm">✓</Text>
                        )}
                      </FormLabel>
                      <InputGroup>
                        <InputLeftElement>
                          <Icon
                            as={FaUser}
                            color={getFieldIconColor('lastName', lastName, errors.lastName)}
                          />
                        </InputLeftElement>
                        <Input
                          {...register("lastName")}
                          ...
                          borderRadius="xl"
                          borderWidth="2px"
                          borderColor={getFieldBorderColor('lastName', lastName, errors.lastName)}
                          _hover={{
                            borderColor: getFieldBorderColor('lastName', lastName, errors.lastName, true),
                          }}
                          _focus={{
                            borderColor: getFieldState('lastName', lastName, errors.lastName) === 'error' 
                              ? 'red.500' 
                              : getFieldState('lastName', lastName, errors.lastName) === 'success'
                                ? 'green.500' 
                                : 'brand.500',
                            boxShadow: getFieldState('lastName', lastName, errors.lastName) === 'error'
                              ? '0 0 0 1px var(--chakra-colors-red-500)'
                              : getFieldState('lastName', lastName, errors.lastName) === 'success'
                                ? '0 0 0 1px var(--chakra-colors-green-500)'
                                : '0 0 0 1px var(--chakra-colors-brand-500)',
                  ...
                  <HStack spacing={4} w="full" flexDirection={{ base: "column", md: "row" }}>
                    <FormControl isInvalid={!!errors.email}>
                      <FormLabel fontWeight="700" color="gray.700">
                        Email Address
                      </FormLabel>
                      <InputGroup>
                        <InputLeftElement>
              ...
              >
                ...
                <Text fontSize="sm" color="green.600" fontWeight="500">
                  We comply with Nigerian healthcare privacy regulations and
