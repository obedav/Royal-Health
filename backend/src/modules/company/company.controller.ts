...
export class CompanyController {
  ...
  getAbout() {
    return {
      ...
      description:
        "Royal Health Consult is Nigeria's leading home healthcare service provider, offering professional medical care in the comfort of your home.",
      mission:
        'To provide accessible, quality healthcare services to every Nigerian family.',
